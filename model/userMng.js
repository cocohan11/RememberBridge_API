...
const { JWT_ACCESS_TOKEN_KEY, JWT_REFRESH_TOKEN_KEY, KAKAO_REST_API_KEY, KAKAO_REDIRECT_URI, KAKAO_CLIENT_SECRET } =
    process.env;
 ...
 */
userMng.prototype.leaveSns = async (query) => {
    // 이메일, sns type
...
/** 회원탈퇴 (일반, SNS 유저 포함)*/
userMng.prototype.leaveUser = (query) => {
    // 논리삭제 (물리삭제X)
    // 회원탈퇴 쿼리문 작성
