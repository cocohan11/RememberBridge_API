...
router.post('/mypage/info', async (req, res) => {
    ...
    const apiName = '마이페이지 유저정보조회 API';
    console.log('API : ', apiName);
    console.log('req.body %o: ', req.body);

    // 파라미터 누락 확인
    if (!req.body.user_email) {
        console.log('req.body.email %o:', req.body.user_email);
...
// 마이페이지 비밀번호 수정 API
// Params : user_email, user_pw
router.post('/mypage/change/pw', async (req, res) => {});
// Params : user_email, user_profile
router.post('/mypage/change/profile', async (req, res) => {});
